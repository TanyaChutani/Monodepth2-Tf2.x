...
class Depth_Estimation(tf.keras.models.Model):
    def __init__(self,
        ...
        self.maxpool_layer = tf.keras.layers.MaxPool2D(pool_size=(2, 2),
                                                       strides=2,
                                                       padding="same")
        self.conv_decoder_layer = tf.keras.layers.Conv2D(1, 
                                                         3, 
                                                         padding='same',
                                                         activation='sigmoid')
        self.conv2_decoder_layer = tf.keras.layers.Conv2D(1, 
                                                          3, 
                                                          padding='same',
                                                          activation='sigmoid')
        self.conv3_decoder_layer = tf.keras.layers.Conv2D(1, 
                                                          3, 
                                                          padding='same',
                                                          activation='sigmoid')
        self.conv4_decoder_layer = tf.keras.layers.Conv2D(1, 
                                                          3, 
                                                          padding='same',
                                                          activation='sigmoid')
        self.conv5_decoder_layer = tf.keras.layers.Conv2D(1, 
                                                          3, 
                                                          padding='same',
                                                          activation='sigmoid')
